...
import br.com.hussan.mvrx.data.model.*
import br.com.hussan.mvrx.data.model.request.*
import br.com.hussan.mvrx.data.model.response.*
import br.com.hussan.mvrx.extensions.asGB
import br.com.hussan.mvrx.extensions.asMB
import br.com.hussan.mvrx.extensions.dateOf
...
class FakeAppApi : AppApi {
    ...
    override fun getOrderDetail(userToken: String, orderId: String, idLine: String): Observable<GetOrderDetailResponse> = GetOrderDetailResponse("", emptyList(), "", OrderDetail("A3259557", "nextel", "Portabilidade", "Vivo Controle Giga 2,5GB",
